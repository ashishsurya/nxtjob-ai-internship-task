...
const TabTriggers = () => {
  return (
    <Tabs.List className='flex w-60 flex-col py-[20px] px-[10px] bg-white gap-[10px] rounded-lg'>
      <Tabs.Trigger
        value='boards'
        className='p-[10px] data-[state=active]:bg-[#8246FD] data-[state=active]:text-white flex gap-[10px] items-center rounded-lg data-[state=inactive]:hover:bg-[#F5F5F5]'
      >
